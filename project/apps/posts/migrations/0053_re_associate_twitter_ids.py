...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        from posts.social import authorized_tweepy_api
        from django.core.urlresolvers import reverse

        for author in orm['posts.Author'].objects.all():
                    ...
                    for s in statuses:
                        for u in s.entities["urls"]:
                            if "expanded_url" in u:
                                ...
                                if permalink == u["expanded_url"]:
                                    print "match found: %s" % permalink
                                    post.twitter_status_id = s.id
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 7, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
